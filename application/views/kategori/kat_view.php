					...
					<div class="box box-warning">
						...
						<div class="box-body">
							...
							<form method="post" action="<?= base_url('data/katproses');?>">
								...
								<button type="submit" class="btn btn-warning"> <i class="fa fa-plus"></i> Tambah Kategori</button>
							</form>
							<?php }?>
						</div>
					</div>
							...
							<table id="example1" class="table table-bordered table-striped table" width="100%">
								...
								<?php $no=1;foreach($kategori->result_array() as $isi){?>
									<tr>
										...
										<td style="width:20%;">
											<a href="<?= base_url('data/kategori?id='.$isi['id_kategori']);?>"><button class="btn btn-primary"><i class="fa fa-edit"></i></button></a>
