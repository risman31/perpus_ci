					...
					<div class="box box-warning">
						...
						<div class="box-body">
							...
							<form method="post" action="<?= base_url('transaksi/dendaproses');?>">
								...
								<button type="submit" class="btn btn-warning"> <i class="fa fa-plus"></i> Tambah Harga Denda</button>
							</form>
							<?php }?>
						</div>
					</div>
							...
							<table id="example1" class="table table-bordered table-striped table" width="100%">
								...
								<?php $no=1;foreach($denda->result_array() as $isi){?>
									<tr>
										...
										<td><?= $isi['tgl_tetap'];?></td>
										<td style="width:20%;">
											<a href="<?= base_url('transaksi/denda?id='.$isi['id_biaya_denda']);?>"><button class="btn btn-primary"><i class="fa fa-edit"></i></button></a>
