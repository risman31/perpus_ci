...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/buku2.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  ...
  <div class="login-box-body" style="border:2px solid #226bbf;">
    ...
    <form action="<?= base_url('login/auth');?>" method="POST">
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          <button type="submit" id="loding" class="btn btn-warning btn-block btn-flat">Sign In</button>
  ...
  <footer>
    <div class="login-box-body text-center bg-yellow">
       <a style="color: black;"> Copyright &copy; Sistem Perpustakaan PT. Digiwork Teknology - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
