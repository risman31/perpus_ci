...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <i class="fa fa-book" style="color:black"> </i>  <?= $title_web;?>
    </h1>
    <ol class="breadcrumb">
					...
					<table class="table table-striped table-bordered">
						...
						<tr>
							...
							<td><?php if(!empty($buku->sampul !== "0")){?>
									<a href="<?= base_url('assets_style/image/buku/'.$buku->sampul);?>" target="_blank">
										...
										style="width:170px;height:170px;" class="img-responsive">
									</a>
						...
						<tr>
							...
							<td>
								...
								?> 
								<a data-toggle="modal" data-target="#TableAnggota" class="btn btn-warning btn-xs" style="margin-left:1pc;">
						...
						<tr>
							...
							<td><?php if(!empty($buku->lampiran !== "0")){?>
									<a href="<?= base_url('assets_style/image/buku/'.$buku->lampiran);?>" class="btn btn-warning btn-md" target="_blank">
