...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <i class="fa fa-plus" style="color:black"> </i>  <?= $title_web;?>
    </h1>
    <ol class="breadcrumb">
										...
										<td>
											<div class="input-group">
												...
												<span class="input-group-btn">
													<a data-toggle="modal" data-target="#TableAnggota" class="btn btn-warning"><i class="fa fa-search"></i></a>
												</span>
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<div class="input-group">
												...
												<span class="input-group-btn">
													<a data-toggle="modal" data-target="#TableBuku" class="btn btn-warning"><i class="fa fa-search"></i></a>
												</span>
											</div>
										</td>
									</tr>
		...
		<?php $no=1;foreach($buku->result_array() as $isi){?>
			<tr>
				...
				<a href="<?= base_url('data/bukudetail/'.$isi['id_buku']);?>" target="_blank">
					<button class="btn btn-warning"><i class="fa fa-sign-in"></i> Detail</button></a>
				</td>
			</tr>
		<?php $no++;}?>
		</tbody>
