...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <i class="fa fa-sign-out" style="color:black"> </i>  <?= $title_web;?>
    </h1>
    <ol class="breadcrumb">
	        ...
	        <div class="box box-warning">
			    ...
			    <div class="box-body">
						<div class="row">
							<div class="col-sm-5">
								<table class="table table-striped">
									...
									<tr>
										<td>No Peminjaman</td><td>:</td><td><?= $pinjam->pinjam_id;?></td>
									</tr>
									<tr>
										<td>Tgl Peminjaman</td><td>:</td><td><?= $pinjam->tgl_pinjam;?></td>
									</tr>
									<tr>
										<td>Tgl pengembalian</td><td>:</td><td><?= $pinjam->tgl_balik;?></td>
									</tr>
									<tr>
										<td>ID Anggota</td><td>:</td><td><?= $pinjam->anggota_id;?></td>
									</tr>
									<tr>
										<td>Biodata</td>
										<td>:</td>
                        ...
                        <div class="pull-right">
							<a data-toggle="modal" data-target="#TableDenda" class="btn btn-warning btn-md" style="margin-left:1pc;">
...
<div class="modal-footer">
	<div class="pull-right">
		...
		<button class="btn btn-warning"> Proses Pengembalian</button></a>
