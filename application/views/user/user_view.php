...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <i class="fa fa-edit" style="color:black"> </i>  Daftar Data User
    </h1>
    <ol class="breadcrumb">
	    ...
	    <div class="col-md-12">
	        <div class="box box-warning">
                <div class="box-header with-border">
                    <a href="user/tambah"><button class="btn btn-warning"><i class="fa fa-plus"> </i> Tambah User</button></a>
                    ...
                    <table id="example1" class="table table-bordered table-striped table" width="100%">
                        ...
                        <?php $no=1;foreach($user as $isi){?>
                            <tr>
                                ...
                                <td><?= $isi['alamat'];?></td>
                                <td style="width:20%;">
                                    <a href="<?= base_url('user/edit/'.$isi['id_login']);?>"><button class="btn btn-warning"><i class="fa fa-edit"></i></button></a>
